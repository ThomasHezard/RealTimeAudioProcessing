...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar0 = (SeekBar) findViewById(R.id.activity_main_seek_bar_0);
        seekBar1 = (SeekBar) findViewById(R.id.activity_main_seek_bar_1);

        seekBar0.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                float percent = ((float) seekBar0.getProgress()) / 1000f;
                setParam(0, percent);
            }
        ...
        seekBar1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                float percent = ((float) seekBar1.getProgress()) / 1000f;
                setParam(1, percent);
            }
    ...
    public static native void setParam(int id, float value);
}
